import { LocalItem, Rarity, WearableCategory as LocalItemWearableCategory, RemoteItem } from '@mtvproject/builder-client'
import { BodyShape, WearableCategory } from '@mtvproject/schemas'
