import { ChainId, Network, BodyShape } from '@mtvproject/schemas'
...
describe('when getting the catalyst item URN', () => {
  ...
  beforeEach(() => {
    ;(getChainIdByNetwork as jest.Mock).mockReturnValueOnce(ChainId.U2U_MAINNET)
  })
  ...
  it('should get the chain id for the matic network', () => {
    ...
    expect(getChainIdByNetwork).toHaveBeenCalledWith(Network.U2U)
  })
})
