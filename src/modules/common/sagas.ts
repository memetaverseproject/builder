...
import { toastSaga } from '@mtvproject/dapps/dist/modules/toast/sagas'
import { featuresSaga } from '@mtvproject/dapps/dist/modules/features/sagas'
...
export function* rootSaga(
  ...
  yield all([
    ...
    poolSaga(builderAPI),
    createProfileSaga({ peerUrl: PEER_URL, peerWithNoGbCollectorUrl: getPeerWithNoGBCollectorURL() })(),
    ...
    featuresSaga({ polling: { apps: [], delay: 60000 /** 60 seconds */ } }),
