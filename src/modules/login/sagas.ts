import { ConnectWalletSuccessAction, CONNECT_WALLET_SUCCESS, CONNECT_WALLET_FAILURE } from '@mtvproject/dapps/dist/modules/wallet/actions'
import { openModal, CloseModalAction, CLOSE_MODAL, closeModal } from '@mtvproject/dapps/dist/modules/modal/actions'
