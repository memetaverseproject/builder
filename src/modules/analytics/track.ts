...
import { add } from '@mtvproject/dapps/dist/modules/analytics/utils'
import { getTransactionFromAction } from '@mtvproject/dapps/dist/modules/transaction/utils'
import { GRANT_TOKEN_SUCCESS, REVOKE_TOKEN_SUCCESS } from '@mtvproject/dapps/dist/modules/authorization/actions'
import { SET_PROFILE_AVATAR_ALIAS_SUCCESS } from '@mtvproject/dapps/dist/modules/profile/actions'
import { OPEN_MODAL, CLOSE_MODAL } from '@mtvproject/dapps/dist/modules/modal/actions'
import {
  DROP_ITEM,
  RESET_ITEM,
  DUPLICATE_ITEM,
