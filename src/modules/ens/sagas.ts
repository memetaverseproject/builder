...
import { BuilderClient, LandHashes } from '@mtvproject/builder-client'
import { ContractName, getContract } from '@mtvproject/transactions'
import { getChainIdByNetwork, getNetworkProvider, getSigner } from '@mtvproject/dapps/dist/lib/eth'
import { getAddress } from '@mtvproject/dapps/dist/modules/wallet/selectors'
import { CONNECT_WALLET_SUCCESS, ConnectWalletSuccessAction } from '@mtvproject/dapps/dist/modules/wallet/actions'
import { Wallet } from '@mtvproject/dapps/dist/modules/wallet/types'
import { getCurrentLocale } from '@mtvproject/dapps/dist/modules/translation/utils'
...
export function* ensSaga(builderClient: BuilderClient, ensApi: ENSApi) {
  ...
  function* handleFetchAuthorizationRequest(_action: FetchENSAuthorizationRequestAction) {
    try {
      ...
      const contract = getContract(ContractName.MtvToken, chainId)
