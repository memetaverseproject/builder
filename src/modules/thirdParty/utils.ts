...
import { getChainIdByNetwork, getConnectedProvider } from '@mtvproject/dapps/dist/lib/eth'
import { Provider } from '@mtvproject/dapps/dist/modules/wallet/types'
...
export function* getPublishItemsSignature(thirdPartyId: string, qty: number) {
  ...
  // TODO: expose this as a function in @mtvproject/transactions
