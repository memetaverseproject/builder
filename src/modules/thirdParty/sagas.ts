...
import { Authenticator, AuthIdentity } from '@mtvproject/crypto'
...
import { closeModal, openModal } from '@mtvproject/dapps/dist/modules/modal/actions'
import { showToast } from '@mtvproject/dapps/dist/modules/toast/actions'
import { t } from '@mtvproject/dapps/dist/modules/translation/utils'
import { ContractData, ContractName, getContract } from '@mtvproject/transactions'
...
export function* thirdPartySaga(builder: BuilderAPI, catalystClient: CatalystClient) {
  ...
  function* handleReviewThirdPartyRequest(action: ReviewThirdPartyRequestAction) {
    ...
    try {
      ...
      const thirdPartyContract: ContractData = yield call(getContract, ContractName.ERC20, maticChainId)
