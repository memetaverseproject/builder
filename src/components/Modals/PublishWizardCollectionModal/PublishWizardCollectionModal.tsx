...
import { List, ModalNavigation } from '@mtvproject/ui'
import Modal from '@mtvproject/dapps/dist/containers/Modal'
import { t } from '@mtvproject/dapps/dist/modules/translation/utils'
import { withAuthorizedAction } from '@mtvproject/dapps/dist/containers'
import { AuthorizedAction } from '@mtvproject/dapps/dist/containers/withAuthorizedAction/AuthorizationModal'
import { ContractName } from '@mtvproject/transactions'
import { AuthorizationType } from '@mtvproject/dapps/dist/modules/authorization/types'
import { NFTCategory, Network } from '@mtvproject/schemas'
...
export const PublishWizardCollectionModal: React.FC<Props> = props => {
  ...
  const handleOnPublish = () => {
    const authorization = buildManaAuthorization(wallet.address, wallet.networks.U2U.chainId, ContractName.CollectionManager)
    const manaContract = {
