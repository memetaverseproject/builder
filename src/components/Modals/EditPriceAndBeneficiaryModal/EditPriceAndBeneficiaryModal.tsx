        ...
        <Form onSubmit={this.handleSubmit}>
          <ModalContent>
            <div className="price-field">
              ...
              />
              <Mtv showTooltip network={Network.U2U} inline />
                  ...
                  <div>
                    {this.isPriceTooLow() ? (
                      <T
                        ...
                        values={{
                          minPrice: (
                            <Mtv showTooltip inline network={Network.U2U}>
                              {MIN_SALE_VALUE}
                            </Mtv>
                          ),
                          token: t(`tokens.${Network.U2U.toLowerCase()}`),
                          br: <br />
                        }}
                      />
                    ) : isFree ? (
          ...
          <ModalActions>
            <NetworkButton primary disabled={this.isDisabled()} loading={isLoading} network={Network.U2U}>
              {t('global.save')}
            </NetworkButton>
            {!!onSkip && (
