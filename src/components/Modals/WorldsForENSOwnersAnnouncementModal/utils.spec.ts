import { getLocalStorage } from '@mtvproject/dapps/dist/lib/localStorage'
import { LocalStorage } from '@mtvproject/dapps/dist/lib/types'
import {
...
jest.mock('@mtvproject/dapps/dist/lib/localStorage')
