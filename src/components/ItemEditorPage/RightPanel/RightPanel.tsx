...
import { Loader, Dropdown, Button } from '@mtvproject/ui'
import { BodyPartCategory, EmoteCategory, EmoteDataADR74, HideableWearableCategory, Network, WearableCategory } from '@mtvproject/schemas'
                  ...
                  <div className="container">
                    ...
                    {isDirty ? (
                      <div className="edit-buttons">
                        ...
                        <NetworkButton primary onClick={this.handleOnSaveItem} network={Network.U2U}>
                          {t('global.save')}
                        </NetworkButton>
                      </div>
