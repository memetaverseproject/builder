...
import { EmoteDataADR74, Network, WearableCategory } from '@mtvproject/schemas'
import { t } from '@mtvproject/dapps/dist/modules/translation/utils'
import { Dropdown, Icon, Button, Mtv, Table } from '@mtvproject/ui'
    ...
    return item.price ? (
      <div>
        {isFree(item) ? (
          ...
          <Mtv className={styles.mana} network={Network.U2U} showTooltip>
      ...
      <div className={styles.itemActions}>
        ...
        >
          <Dropdown.Menu className={styles.contextMenu}>
            ...
            <Dropdown.Item text={t('collection_context_menu.see_in_memetaverse')} onClick={this.handleSeeInWorld} />
